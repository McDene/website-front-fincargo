          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full text-left px-6 py-4 flex justify-between items-center text-lg md:text-3xl font-semibold text-darkBlue hover:text-blue-950 hover:bg-blue-50 transition duration-300"
              >
