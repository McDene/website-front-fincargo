...
export default function NotFound() {
  return (
    <div className="flex items-center justify-center h-screen bg-gradient-to-br from-blue-200 to-blue-950 text-white text-center">
      <div>
        <h1 className="text-9xl text-blue-950 font-bold mb-4">404</h1>
