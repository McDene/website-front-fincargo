  ...
  fr: {
    ...
    whyPeppol: {
      ...
      bullets: [
        ...
        "Réduction des rejets fiscaux grâce au 100-FPA",
        "Accélération de la reconnaissance des revenus",
        "DSO nettement réduit",
        "Suppression des PDF et des processus manuels",
      ],
